- [React](#react)
  - [Основы React](#основы-react)
    - [**_Установка и запуск:_**](#установка-и-запуск)
    - [**_Компоненты:_**](#компоненты)
    - [**_Стили:_**](#стили)
    - [**_Параметры в компонент и циклы:_**](#параметры-в-компонент-и-циклы)
    - [**_События:_**](#события)
  - [Условный рендеринг](#условный-рендеринг)
    - [**_Встроенные условия `if` с оператором &&:_**](#встроенные-условия-if-с-оператором-)
    - [**_Встроенные условие с тренарным оператором:_**](#встроенные-условие-с-тренарным-оператором)
    - [**_Предотвражение рендеринга компонента:_**](#предотвражение-рендеринга-компонента)
  - [Формы](#формы)
